"""
tests/test_validator_v1_0.py
Version: 1.0.0
Deterministic unit tests for AI Schema Validator v1.0
"""
...
def test_entry_shift_exceeded_reject_by_atr_bound():
    ai = base_ai_confirm()
    ai["entry"] = 2005.1  # shift=5.1
    r = validate_ai_response_v1_0(
        ai,
        base_engine(),
        policy=ValidationPolicy(entry_shift_max_atr_mult=0.25, entry_shift_max_pct=0.0),
    )
    assert r.ok is False
